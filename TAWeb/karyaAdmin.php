            ...
            <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body" style="overflow: auto">
                    <h3><i class="mdi mdi-palette-advanced menu-icon"></i> KARYA</h3><br>
                    <form action="searchKarya.php" method="get" style="width: 80rem;">
                    <div class="input-group">
                      <a href="insertFormKarya.php"><button type="button" class="btn btn-outline-primary btn-icon-text" style="margin-right: 50px">
                      <i class="mdi mdi-plus-box btn-icon-prepend"></i>Add</button></a>
                      <input type="text" class="form-control rounded" placeholder="Cari ID Karya, Nama Karya, Kategori, atau Seniman" aria-label="Search" aria-describedby="search-addon" name="cari" required/>
                    ...
                    <table class="table table-hover">
                      ...
                      <tbody>
                        <tr>
                          <td>
                            <a href="editFormKarya.php?id_karya=<?php echo $row["id_karya"]; ?>">
                          ...
                          <td>
                            <a href="deleteKarya.php?id_karya=<?php echo $row["id_karya"]; ?>" onclick="return confirm('Are you sure to delete this data?')">
                          ...
                          <td><?php echo "<img src = 'img/$row[gambar]' class='mb-2 mw-200 w-100 rounded'/>"; ?></td>
