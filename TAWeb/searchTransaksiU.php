                ...
                <div class="card">
                  <div class="card-body" style="overflow: auto">
                    ...
                    <div class="input-group">
                      <a href="transaksiUser.php"><button type="button" class="btn btn-outline-warning btn-icon-text">
                    ...
                    <table class="table table-hover">
                      ...
                      <?php
                        ...
                        WHERE (u.username = '$nama' AND t.id_transaksi = '$cari') OR 
                        (u.username = '$nama' AND e.nama LIKE '%$cari%') OR 
                        (u.username = '$nama' AND t.status = '$cari')";
                        $result = mysqli_query($connect, $query);
