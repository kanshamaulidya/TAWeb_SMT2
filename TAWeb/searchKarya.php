                ...
                <div class="card">
                  <div class="card-body" style="overflow: auto">
                    ...
                    <div class="input-group">
                      <a href="karyaAdmin.php"><button type="button" class="btn btn-outline-warning btn-icon-text">
                      <i class="mdi mdi-arrow-left-bold btn-icon-prepend"></i>Back</button></a>
                    </div>
                    <table class="table table-hover">
                      ...
                      <?php
                        ...
                        $query = "SELECT * FROM karya WHERE id_karya = '$cari' OR nama_karya LIKE '%$cari%' OR seniman LIKE '%$cari%' OR kategori LIKE '%$cari%'";
                        $result = mysqli_query($connect, $query);
                      ...
                      <tbody>
                        <tr>
                            ...
                            <td>
                                <a href="deleteKarya.php?id_karya=<?php echo $row["id_karya"]; ?>">
                            ...
                            <td style="overflow: visible"><?php echo $row["deskripsi"]; ?></td> 
                        </tr>
                        <tr></tr>
                        <tr></tr>
                        <tr rowspan = "3"></tr>
