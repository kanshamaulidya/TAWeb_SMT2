        ...
        <div class="row" style="overflow: auto">
            <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                    ...
                    <p class="card-description"> Selesaikan pembayaran untuk mendapatkan tiket Anda. </p>
                    <form class="forms-sample" style="width: 70rem" action="bookingContProcc.php" method="post">
                      ...
                      <label>Harga</label>   
                        ...
                        <div class="input-group-prepend">
                          ...
                          <?php
                                ...
                                $query = "SELECT id_event FROM transaksi WHERE id_transaksi = '$idTransaksi'";
                                $result = mysqli_query($connect, $query);
                          ...
                          ?>
                        <input type="number" class="form-control" name="myharga" value="<?php echo $baris['harga']; ?>" readonly>
                      ...
                      ?>
                        <a href="bookingContProcc.php?id_transaksi=<?php echo $idTransaksi?>">
                            <button type="submit" class="btn btn-outline-success btn-icon-text" name="pay" value="Pay" style="float: right">
                            <i class="mdi mdi-arrow-right-bold btn-icon-prepend"></i>Pay</button>
                        </a>
                    </form>
                  </div>
                </div>
