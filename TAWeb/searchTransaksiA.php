                ...
                <div class="card">
                  <div class="card-body" style="overflow: auto">
                    ...
                    <div class="input-group">
                      <a href="transaksiAdmin.php"><button type="button" class="btn btn-outline-warning btn-icon-text">
                    ...
                    <table class="table table-hover">
                      ...
                      <?php
                        ...
                        WHERE t.id_transaksi = '$cari' OR e.nama LIKE '%$cari%' OR u.nama_user LIKE '%$cari%' OR t.status = '$cari'";
                        $result = mysqli_query($connect, $query);
                        ...
                        <tr>
                          ...
                          <td colspan = "2">
                            ...
                            <a href="transaksiAProcess.php?id_transaksi=<?php echo $row["id_transaksi"]; ?>">
                                <button type="submit" class="btn btn-outline-danger btn-icon-text" name="tidakhadir" value="Tidak Hadir">
