      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <div class="row" style="overflow: auto">
            <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                    <h3><i class="mdi mdi-pencil-box menu-icon"></i> EDIT EVENT</h3><br>
                    <form class="forms-sample" style="width: 70rem" action="editProcessEvent.php" method="POST" enctype="multipart/form-data">
                      <?php
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="myid_event" value="<?php echo $row['id_event']; ?>" readonly>
                      </div>
                      <div class="form-group">
                        <label>Nama Event</label>
                        <input type="text" class="form-control" name="mynama" value="<?php echo $row['nama']; ?>" required>
                      </div>
                      <div class="form-group">
                        <label>Tanggal</label>
                        <input type="date" class="form-control" name="mytanggal" value="<?php echo $row['tanggal']; ?>" required>
                      </div>
                      <div class="form-group">
                        <label>Harga</label>
                        <input type="number" class="form-control" name="myharga" value="<?php echo $row['harga']; ?>" required>
                      </div>
                      <div class="form-group">
                        <label>Poster</label>
                        <input type="file" class="form-control" name="mygambar" value="<?php echo $row['gambar']; ?>" required>
                      </div>
                      <?php
                        }
                      ?>
                        <a href="eventAdmin.php">
                            <button type="button" class="btn btn-outline-warning btn-icon-text" name="cancel" value="Cancel" style="float: left">
                            <i class="mdi mdi-arrow-left-bold btn-icon-prepend"></i>Back</button>
                        </a>
                        <a href="editProcessEvent.php">
