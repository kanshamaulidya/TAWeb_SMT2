      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <div class="row" style="overflow: auto">
            <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                    <h3><i class="mdi mdi-pencil-box menu-icon"></i> EDIT KARYA</h3><br>
                    <form class="forms-sample" style="width: 70rem" action="editProcessKarya.php" method="POST" enctype="multipart/form-data">
                      <?php
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="mynama" value="<?php echo $row['nama_karya']; ?>" required>
                      </div>
                      <div class="form-group">
                        <label>Kategori</label>
                        <div>
                            <input type="radio" <?= ($row['kategori'] == 'Lukisan')? 'checked': ''?> name="mykategori" id="lukisan" value="Lukisan" required>
                            <label for="lukisan">Lukisan</label>
                        </div>
                        <div>
                            <input type="radio"  <?= ($row['kategori'] == 'Patung')? 'checked': ''?> name="mykategori" id="patung" value="Patung" required>
                            <label for="patung">Patung</label>
                        </div>
                      </div>
                      <div class="form-group">
                        <label>Tahun Rilis</label>
                        <input type="text" class="form-control" name="mytahun" value="<?php echo $row['thn_rilis']; ?>" required>
                      </div>
                      <div class="form-group">
                        <label>Seniman</label>
                        <input type="text" class="form-control" name="myseniman" value="<?php echo $row['seniman']; ?>" required>
                      </div>
                      <div class="form-group">
                        <label>Deskripsi</label>
                        <textarea type ="text" name="mydeskripsi" rows="5" cols="135" required><?php echo $row['deskripsi']; ?></textarea>
                      </div>
                      <div class="form-group">
                        <label>Karya</label>
                        <input type="file" class="form-control" value="<?php echo $row['gambar']; ?>" name="gambar" required>
                      </div>
                      <?php
                        }
                      ?>
