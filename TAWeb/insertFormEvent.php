      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <div class="row" style="overflow: auto">
            <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                    <h3><i class="mdi mdi-plus-box menu-icon"></i> ADD EVENT</h3><br>
                    <form class="forms-sample" style="width: 70rem" action="insertProcessEvent.php" method="POST" enctype="multipart/form-data">
                      <?php
                        include "connectionInsertEvent.php";
                      ?>
                      <div class="form-group">
                        <label>ID Event</label>
                        <input type="text" class="form-control" name="myid_event" value="<?php echo $id_event; ?>" readonly>
                      </div>
                      <div class="form-group">
                        <label>Nama Event</label>
                        <input type="text" class="form-control" name="mynama" placeholder="Nama Event" required>
                      </div>
                      <div class="form-group">
                        <label>Tanggal</label>
                        <input type="date" class="form-control" name="mytanggal" required>
                      </div>
                      <div class="form-group">
                        <label>Harga</label>
                        <input type="number" class="form-control" name="myharga" placeholder="Harga" required>
                      </div>
                      <div class="form-group">
                        <label>Poster</label>
                        <input type="file" class="form-control" name="mygambar" required>
                      </div>
