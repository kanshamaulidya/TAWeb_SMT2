                ...
                <div class="card">
                  <div class="card-body" style="overflow: auto">
                    ...
                    <div class="input-group">
                      <a href="eventAdmin.php"><button type="button" class="btn btn-outline-warning btn-icon-text">
                    ...
                    <table class="table table-hover">
                      ...
                      <?php
                        ...
                        $query = "SELECT * FROM event WHERE id_event = '$cari' OR nama LIKE '%$cari%'";
                        $result = mysqli_query($connect, $query);
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>
                          <a href="deleteEvent.php?id_event=<?php echo $row["id_event"]; ?>">
